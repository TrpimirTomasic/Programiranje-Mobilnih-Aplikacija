...
public class SummaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        oTextViewPrezime = (TextView) view.findViewById(R.id.tvPrezime);
        oTextViewDatumRodenja = (TextView) view.findViewById(R.id.tvDatumRodenja);
        oTextViewProfesor = (TextView) view.findViewById(R.id.tvProfesor);
        oTextViewPredmet = (TextView) view.findViewById(R.id.tvPredmet);
        oTextViewAkademskaGodina = (TextView) view.findViewById(R.id.tvAkademskaGodina);
        oTextViewBrojSatiPredavanja = (TextView) view.findViewById(R.id.tvPredavanja);
        oTextViewBrojSatiVjezbe = (TextView) view.findViewById(R.id.tvVjezbe);
        oBtnPovratak = (Button) view.findViewById(R.id.btnPovratak);
