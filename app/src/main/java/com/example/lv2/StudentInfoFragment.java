...
public class StudentInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        oTextInputEditTextImeProfesor = (TextInputEditText) view.findViewById(R.id.tietProfesor);
        oTextInputEditTextPredmet = (TextInputEditText) view.findViewById(R.id.tietPredmet);
        oTextInputEditTextAkademskaGodina = (TextInputEditText) view.findViewById(R.id.tietAkademskaGodina);
        oTextInputEditTextBrojSatiPredavanje = (TextInputEditText) view.findViewById(R.id.tietBrojSatiPredavanja);
        oTextInputEditTextBrojSatiVjezbe = (TextInputEditText) view.findViewById(R.id.tietBrojSatiVjezbe);
        oBtnDalje2 = (Button) view.findViewById(R.id.btnDalje2);
