...
public class PersonalInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        oInputLayoutIme= (TextInputEditText) view.findViewById(R.id.tietIme);
        oInputLayoutPrezime = (TextInputEditText) view.findViewById(R.id.tietPrezime);
        oEditTextDatum = (EditText) view.findViewById(R.id.etDatum);
